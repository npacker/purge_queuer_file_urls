...
class FilesQueuerConfigForm extends QueuerConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['url_options']['absolute_urls'] = [
      ...
      '#description' => $this->t('Urls can be purged as <em>absolute</em> ("http://www.site.com/path/file.ext") or <em>root-relative</em> ("/path/file.ext"). <strong>Ensure that a purger with the corresponding type is configured under the "Cache Invalidation" options.</strong>'),
